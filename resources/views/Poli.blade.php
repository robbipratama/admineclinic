                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="input1-group2" name="keywords" placeholder="Cari Nama Poli" class="form-control">
                                            ...
                                            <table class="table table-borderless table-data3">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $data->nama }}</td>
                                                        <td>
                                                            <a href="{{ url('/poli/edit/' .$data->id) }}">
                                                                <button type="button" class="btn btn-warning btn-sm text-white">
                                                                    <i class="fas fa-pencil-alt"></i>
                                                                </button>
                                                            </a>
                                                            <a href="javascript:if(confirm('Apakah anda yakin ingin menghapus data ?')) window.location.href = '{{ url('/poli/delete/' .$data->id) }}'">
