                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="input1-group2" name="keywords" placeholder="Cari Nama User" class="form-control">
                                            ...
                                            <table class="table table-borderless table-data3">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="javascript:if(confirm('Apakah anda yakin ingin menghapus data ?')) window.location.href = '{{ url('/data-user/delete/' .$data->id) }}'">
