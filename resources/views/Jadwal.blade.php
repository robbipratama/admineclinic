                                            ...
                                            <table class="table table-borderless table-data3">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($data->hari == 1) Senin @endif
                                                            @if($data->hari == 2) Selasa @endif
                                                            @if($data->hari == 3) Rabu @endif
                                                            @if($data->hari == 4) Kamis @endif
                                                            @if($data->hari == 5) Jumat @endif
                                                            @if($data->hari == 6) Sabtu @endif
                                                            @if($data->hari == 7) Minggu @endif
                                                        </td>
                                                        <td>{{ $data->jam }}</td>
                                                        <td>
                                                            <a href="{{ url('/jadwal/edit/' .$data->id) }}">
                                                                <button type="button" class="btn btn-warning btn-sm text-white">
                                                                    <i class="fas fa-pencil-alt"></i>
                                                                </button>
                                                            </a>
                                                            <a href="javascript:if(confirm('Apakah anda yakin ingin menghapus data ?')) window.location.href = '{{ url('/jadwal/delete/' .$data->id) }}'">
